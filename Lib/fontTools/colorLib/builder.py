...
def buildCOLR(
    ...
    deltaSetIndexMap: Optional[ot.DeltaSetIndexMap] = None,
    ...
    Args:
        ...
        deltaSetIndexMap: Optional DeltaSetIndexMap for deltas associated with v1 layer.
    Return:
        A new COLR table.
    """
    ...
    if version == 0:
        ...
        colr.DeltaSetIndexMap = deltaSetIndexMap
